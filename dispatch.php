...
<body>
    ...
    <div class="form-group row">
        <label for="contatNo" class="col-sm-4 col-form-label">Contact Number</label>
        <div class="col-sm-8">
            <?php echo $contactNo;?>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-8"><?php echo $descriptionofIncident; ?>
...
<footer class="page-footer font-small blue pt-4 footer-copyright text-center py-3">
    ...
    <script type="text/javascript" src="js/j=popper.min.js"></script>
